...
template<typename Function>
void LaunchKernel(int n, Function f, int sharedMemorySize=0, cudaStream_t stream=0, int numThreads=128)
{
...
template<typename Function>
void LaunchKernel(int nx, int ny, Function f, int sharedMemorySize = 0, cudaStream_t stream = 0)
{
